...
public class MessagesDataSource {
    ...
    private String[] allColumns = {MySQLiteHelper.MESSAGE_ID,
            MySQLiteHelper.COLUMN_ADDRESS,MySQLiteHelper.COLUMN_NAME,MySQLiteHelper.COLUMN_NUMBER,MySQLiteHelper.COLUMN_MEALS};
    ...
    public Message createMessage(String title, String description,String time,String meals) {
